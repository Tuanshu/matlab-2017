...
root_folder_path='C:\TuanShu\170614_PhotonFocus with EMScanner\';
...
last_folder_name='NN measurement';%
Number=[16];

System='780';

If_EM2=1;
If_Auto_Brightness=0;
If_Calculate_NN=1;
...
NN_Y_Range=4;
If_Search_Glass=0;
Assumed_Glass_Interface_Index=950;
If_Norm=0;
...
% ylim([0 0.01]);
if If_Calculate_NN == 1
    Test_Image=squeeze(After_Npoint_Image_Stack(X_ROI(1):X_ROI(2),NN_Y_Range,Signal_Range(1):Signal_Range(2)))';
