clear all
%%
root_folder_path='F:\170110_e2v EM1 new setup\after adj(opt by Imperx)\after resolution adj';
%root_folder_path='I:\161223_e2v EM1\CeYAG\Different Exp Time';

Data_Name='170110_e2v EM1 new setup';
Current_Array=[5];%[3:3:24];
it=115;
...
for p=1:length(Current_Array)
    file_name=sprintf('Tissue_%g_it%g',Current_Array(p),it);
