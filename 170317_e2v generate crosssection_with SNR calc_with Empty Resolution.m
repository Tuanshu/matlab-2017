...
%%
disc='F:\';
root_folder_path='170313_EM1.4 test';
mid_folder_path='';
sub_folder_path='OldMirau_Realigned_2_Forearm';
Number=1;
...
Data_Image_Npoint_normalized=Display_Gain*(Stitched_Image(:,Horizontal_ROI_View(1):Horizontal_ROI_View(2))-C_min)/(C_max-C_min);
