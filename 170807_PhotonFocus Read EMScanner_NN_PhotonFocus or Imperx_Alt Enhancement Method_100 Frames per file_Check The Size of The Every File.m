...
root_folder_path='C:\TuanShu\170807_Optimizing 100-proj_50CY_Colinear_Non-selective Coating\';
last_folder_name='PreAve8';
Number=[];
...
if strcmp(Camera,'MV1')
    Product_of_Axial_Decimation_Factor_and_Ave_Factor=8;%round(2);
elseif strcmp(Camera,'B0620')
