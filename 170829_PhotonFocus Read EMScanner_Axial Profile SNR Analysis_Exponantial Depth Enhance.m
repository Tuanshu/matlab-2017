...
last_folder_name='170824_Back to EM2-1 Probe';
Number=[1];
...
PreAVE=2;%Product_of_Axial_Decimation_Factor_and_Ave_Factor;%[4*4*4];
...
for QQQ=1:length(folder_list)
  ...
  %%
    ...
    if If_Enhace_Deep_Signal
        Depth_Fit_Range=[120 250];  %micron
