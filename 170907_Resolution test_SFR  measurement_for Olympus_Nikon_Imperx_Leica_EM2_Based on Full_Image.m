clear all
%%
root_folder_path='C:\TuanShu\170907_ASAP Mirau SFR 1st (missaligned coherent)\tiff only';

M=20;
Given_sub_folder_path='20170907143723_64x_SFR target_it0.03_PreAVE1_128x_CCDX offset_Y490_50';

System='EM2PL_ExtendFOV';


ESF_Est_Type=1; % 1 and 2 for error function rought estimation, 3 for fermi, 4: (170906) FWHM
