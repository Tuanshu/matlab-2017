...
for p=1:length(file_list)
    ...
    Data_Save_Folder='C:\Users\Owner\Desktop\031317\Processed Data\';
...
if If_norm ==0
    imwrite(Data_Image_Npoint_normalized,[Data_Save_Folder sprintf('%s_%s_%d_N%.3f_S%.3f_SNR%.1fdB',root_folder_path,sub_folder_path,Number,Noise,Signal,SNR) '_.png'],'png');
elseif If_norm ==1
    imwrite(Data_Image_Npoint_normalized,[Data_Save_Folder sprintf('%s_%s_%d_N%.3f_S%.3f_SNR%.1fdB',root_folder_path,sub_folder_path,Number,Noise,Signal,SNR) '_Norm.png'],'png');
end
