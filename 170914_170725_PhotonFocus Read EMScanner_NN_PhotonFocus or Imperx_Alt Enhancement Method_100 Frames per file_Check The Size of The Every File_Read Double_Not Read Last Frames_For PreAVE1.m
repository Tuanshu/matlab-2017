...
root_folder_path='C:\TuanShu\170914_Compare Bandpass Filtering\Raw Data of Selected Sets\Filtered\';
last_folder_name='PreAVE1 Raw (Change LP SP BW0.02)';
Number=[];
...
%     %colormap(gray);
    ...
    Ad_Image_001 = adapthisteq(single(Lateral_Binned_Image),'ClipLimit',0.01,'NumTiles',[12,38],'Distribution','rayleigh');
    Ad_Image_0005 = adapthisteq(single(Lateral_Binned_Image),'ClipLimit',0.005,'NumTiles',[12,38],'Distribution','rayleigh');
    imwrite(Ad_Image_001,[Processed_Sub_Folder_Name folder_list(QQQ).name 'AD001.png'],'png');
    imwrite(Ad_Image_0005,[Processed_Sub_Folder_Name folder_list(QQQ).name 'AD0005.png'],'png');
 end
