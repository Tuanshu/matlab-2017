...
%%
Time_Whole=1:450000;
Voltage_Waveform_Whole=COEFS.a0+COEFS.a1*(Time_Whole*Multi).^0.5+COEFS.a2*(Time_Whole*Multi);
...
Voltage_Waveform_Output=Voltage_Waveform_Whole(Index_Start:Index_Final);
plot(Time_Output,Voltage_Waveform_Output);

dlmwrite(sprintf('%gx_Voltage_Waveform.txt',Multi),Voltage_Waveform_Output','delimiter','\t','newline','pc','precision', '%.6f');
