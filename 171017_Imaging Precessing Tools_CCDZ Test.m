clear all
%%
root_folder_path='F:\AMO\171017_EM2 with EM3 Mirau_019-100_it0.16_4000fps_128x_PreAVE2_clockwise 1R_oblique\';
last_folder_name='CCDZ opt R3';
Number=[];
%%
...
if strcmp(Task,'CCDZ')
    ...
    AVE_postHilbert=4*2*Product_of_Axial_Decimation_Factor_and_Ave_Factor;
