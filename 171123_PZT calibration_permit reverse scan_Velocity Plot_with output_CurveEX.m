...
plot(Time_New_NoNaN,Voltage_Waveform_New_Equalspacing_noNaN,Time_New_NoNaN,COEFS.a0+COEFS.a1*Time_New_NoNaN.^0.5+COEFS.a2*Time_New_NoNaN,Time_Output_Interp*Interp_Target_Multi,Voltage_Waveform_Interp);
