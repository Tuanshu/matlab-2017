clear all
%%
root_folder_path='C:\TuanShu\171017_EM2 with EM3 Mirau SFR\R4\tiff only\';

M=20;
Given_sub_folder_path='20171017141826_128x_2000fps_0.02it_PreAVE1_Y490_50';
...
elseif strcmp(System,'EM2PL_ExtendFOV')
    ...
    Adaptor_M=200/180;
elseif strcmp(System,'EM2PL_40x')
    Camera_Pixel_Size=10.6; %micron
    Adaptor_M=100/180/(0.482/0.477);
end
...
if strcmp(System,'EM2Imperx')
    ...
    Left_Bound=20;  %100
    Right_Bound=20; %100
elseif strcmp(System,'EM2PL_ExtendFOV')||strcmp(System,'EM2PL_40x')
    SFR_Window_Half_Width=20;   %100
    Left_Bound=20;  %100
    Right_Bound=20; %100
else
...
for FolderNumber=1:TotalFolderNumber
    ...
    for FileNumber=1:TotalFileNumber
        ...
        for FrameNumber=1:TotalFrameNumber
            ...
            elseif strcmp(System,'EM2PL_ExtendFOV')||strcmp(System,'EM2PL_40x')
                Data_Image_Raw=double(imread(file_path,'tiff',FrameNumber))';%.*FF;
                Data_Image_Raw=flip(Data_Image_Raw,1);
            elseif strcmp(System,'OlympusDP73')
                Data_Image_Raw=double(imread(file_path,'tiff',FrameNumber))';%.*FF;
                Data_Image_Raw=flip(Data_Image_Raw,1);
            else
            ...
            Number_of_Edge=min(Number_of_Edge,size(Y_Index_Array,1));
