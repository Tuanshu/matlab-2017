...
Peak_Corr=0;
SFR_Window_Half_Width=200;
Left_Bound=100;
Right_Bound=100;
Filter_Window_HalfWidth=10;
Further_Oversampling_Ratio=1;
...
for Number=1:TotalNumber
    ...
    Sampling_Resolution_Corr=Sampling_Resolution*cos(Angle_Mean/180*pi);
...
%     saveas(gcf,[root_folder_path '\' sub_folder_path '.png'])
    ...
    if 1/Pixel_Phase_Per_Lateral_Pixel>(2*SFR_Window_Half_Width)
