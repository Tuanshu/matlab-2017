...
Lateral_Binning_Factor=2;   %After N-point, lateral
Axial_Binning_Factor=3;   %After N-point, Axial
...
elseif If_norm ==1
    ...
    imwrite(Data_Image_Reduced,[Data_Save_Folder sprintf('%s_%s_%d_N%.2f_S%.2f_SNR%.2fdB_LAF%d_LBF%d',root_folder_path,sub_folder_path,Number,Noise,Signal,SNR,Lateral_Ave_Factor,Lateral_Binning_Factor) '_Norm_Reduced.png'],'png');
