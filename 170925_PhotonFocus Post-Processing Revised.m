...
Auto_Brightness_TH=0.98;    % Param for Histogram Auto-brightness
If_CLAHE=0;
ClipLimit=0.01;             % Param for CLAHE, 因為CLAHE不做normalization, 所以最好還是在Autobrightness後做
Imaging_Depth_Range=[50 301];
