...
for QQQ=1:length(last_folder_name)
    ...
    elseif If_EffMap ==0
        imwrite(Lateral_Binned_Image,[Processed_Data_Path sprintf('_Bscan_AAF_%d_RBF_%d_CBF_%d_ABTH_%g_AVE_%d.png',Axial_ave_Factor,Row_Binning_Factor,Column_Binning_Factor,Auto_Brightness_TH,ave_factor)],'png');
    elseif If_EffMap ==-1
