clear all
%%
Save_File_Name='170417_New Imperx Data';
...
Row_Binning_Factor=4;   %New Param 170413
Y_Ave_Factor=8;
ave_factor=[4];
...
%%
    ...
    elseif If_EffMap ==0
        imwrite(Lateral_Binned_Image,[Processed_Data_Path sprintf('_Bscan_AAF_%d_RBF_%d.png',Axial_ave_Factor,Row_Binning_Factor)],'png');
    elseif If_EffMap ==-1
