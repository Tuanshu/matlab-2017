clear all
%%
Save_File_Name='170417_Review Imperx Data';
root_folder_path='D:\170417_Imperx+150mm Proj Lens Test\Scan\';
last_folder_name=[1];


If_EM2=1;
If_Auto_Brightness=1;
Auto_Brightness_TH=0.97;

If_EffMap=0;
If_Norm=1;
Data_Save_Folder='D:\170417_Imperx+150mm Proj Lens Test\Scan\Processed Data\';
...
for QQQ=1:length(last_folder_name)
    ...
    elseif If_EffMap ==0
        imwrite(Lateral_Binned_Image,[Processed_Data_Path sprintf('_Bscan_AAF_%d_LAF_%d_CBF_%d_ABTH_%g.png',Axial_ave_Factor,Lateral_Ave_Factor,Column_Binning_Factor,Auto_Brightness_TH)],'png');
    elseif If_EffMap ==-1
