...
Save_File_Name='170607_EM2 780 with PhotonFocus';
root_folder_path='F:\170607_PhotonFocus Test\';
...
last_folder_name='32x_520fps_Forearm';%
Number=[3];
...
for QQQ=1:length(Number)
    folder_path=[root_folder_path sprintf('%s_%g',last_folder_name,Number) '\'];
    cd(folder_path);
