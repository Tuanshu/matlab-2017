...
root_folder_path='C:\TuanShu\170920_New Mirau+SO Test\';
last_folder_name='64x_PreAVE2';
Number=[];
...
If_EM2=1;
If_Auto_Brightness=2;   %0: Do nothing, 1: Histogram Auto-brightness, 2: CLAHE
Auto_Brightness_TH=0.99;    % Param for Histogram Auto-brightness
If_CLAHE=1;
ClipLimit=0.0025;             % Param for CLAHE, 因為CLAHE不做normalization, 所以最好還是在Autobrightness後做
