...
for QQQ=1:length(last_folder_name)
    ...
    elseif If_EffMap ==0
        imwrite(Lateral_Binned_Image,[Processed_Data_Path sprintf('_Bscan_AAF_%d_LAF_%d_CBF_%d_ABTH_%g_AVE_%d.png',Axial_ave_Factor,Lateral_Ave_Factor,Column_Binning_Factor,Auto_Brightness_TH,ave_factor)],'png');
    elseif If_EffMap ==-1
