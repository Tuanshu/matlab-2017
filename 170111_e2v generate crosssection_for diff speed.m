clear all
%%
root_folder_path='F:\170111_e2v EM1 new setup\Different Speed\128 micron per sec';
%root_folder_path='I:\161223_e2v EM1\CeYAG\Different Exp Time';

Data_Name='170111_e2v EM1 new setup_Diff Speed';
...
for p=1:length(Current_Array)
    file_name=sprintf('Glass_%g_%gdB_it%g',Current_Array(p),Gain,it);
