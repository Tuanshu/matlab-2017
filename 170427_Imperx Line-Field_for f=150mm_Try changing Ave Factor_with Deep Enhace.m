...
Save_File_Name='170426_Review Imperx Data';
root_folder_path='D:\170426_SFR Target on EM2\Pork (after 33)\';
last_folder_name=[26];
...
If_EffMap=0;%0;
If_Norm=1;
Data_Save_Folder='D:\170426_SFR Target on EM2\Pork (after 33)\Processed Data\';
...
%Y_Ave_Factor=8;
Product_of_Axial_Decimation_Factor_and_Ave_Factor=round(64);
...
%%        
    ...
    elseif If_EffMap ==0
        if If_Enhace_Deep_Signal
            imwrite(Lateral_Binned_Image,[Processed_Data_Path sprintf('_Bscan_AAF_%d_LAF_%d_CBF_%d_ABTH_%g_AVE_%d_Phase_%d_ProductAVE_%d_Colomn_%d_DeepEnhace.png',Axial_ave_Factor,Lateral_Ave_Factor,Column_Binning_Factor,Auto_Brightness_TH,ave_factor,Phase_Shift,Product_of_Axial_Decimation_Factor_and_Ave_Factor,Colomn)],'png');
        else
            imwrite(Lateral_Binned_Image,[Processed_Data_Path sprintf('_Bscan_AAF_%d_LAF_%d_CBF_%d_ABTH_%g_AVE_%d_Phase_%d_ProductAVE_%d_Colomn_%d.png',Axial_ave_Factor,Lateral_Ave_Factor,Column_Binning_Factor,Auto_Brightness_TH,ave_factor,Phase_Shift,Product_of_Axial_Decimation_Factor_and_Ave_Factor,Colomn)],'png');
        end
    elseif If_EffMap ==-1
