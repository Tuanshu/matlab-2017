clear all
%%
root_folder_path='F:\170302_EM1.4 test';
%root_folder_path='F:\170111_Save Test';

%root_folder_path='I:\161223_e2v EM1\CeYAG\Different Exp Time';

sub_folder_path='Tissue';

Vertical_Maximum_Depth=1285;    %pixel
...
Data_Name='170302_e2v EM1 new setup';
it=29;
Gain=-24;
Display_Gain=4;
...
ylim([0 max(Y_Label_Array)/SR_Axial/Axial_ave_Factor]);
