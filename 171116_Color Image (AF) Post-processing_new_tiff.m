...
%
%
folder_path='D:\171116_Post-processing of Scheme A Camera\video';
file_name='video0039_300-450';
file_path=[folder_path '\' file_name '.tif'];

for q=1:150
    new_file_path=[folder_path '\' file_name '\' file_name '_modi_' sprintf('%g',q) '.tif'];
    mkdir([folder_path '\' file_name '\']);
    Image_Original=imread(file_path,'tiff','Index',q);
