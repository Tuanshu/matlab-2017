...
Mean_Array_Map=zeros(X_ROI(2)-X_ROI(1)+1,length(Current_Array));
STD_Array_Map=zeros(X_ROI(2)-X_ROI(1)+1,length(Current_Array));
...
for p=1:length(Current_Array)
    ...
    if Noise_Removal_Method == 1
        Mean_Array_Map(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),p)=mean(Image_Stack(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),:),3);
        STD_Array_Map(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),p)=std(Image_Stack(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),:),1,3);
    elseif Noise_Removal_Method == 2
        Mean_Array_Map(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),p)=mean(Image_Stack_norm(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),:),3);
        STD_Array_Map(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),p)=std(Image_Stack_norm(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),:),1,3);    
    elseif Noise_Removal_Method == 3
        Mean_Array_Map(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),p)=mean(Image_Stack_Filter(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),:),3);
        STD_Array_Map(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),p)=std(Image_Stack_Filter(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),:),1,3);        
    elseif Noise_Removal_Method == 4
        Mean_Array_Map(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),p)=mean(Image_Stack(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),:),3);
        STD_Array_Map(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),p)=mean(Image_Stack_Npoint(X_ROI(1):X_ROI(2),Y_ROI(1):Y_ROI(2),:),3)*Unbias_Estimator;        
    end
    disp(p);
end
