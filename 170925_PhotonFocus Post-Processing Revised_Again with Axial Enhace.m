...
Ratio_of_DF_Subtraction_before_Enhance=0.8;%0.8;
Exponantial_Coef=0.05;   % dB/micron
BI=0;%-0.1;
BF=1;
...
%     end
   ...
   %% 
    ...
    if If_Enhace_Deep_Signal ==1
        Z_Profile=Axial_Sampling_Resolution*([0:(size(Reduced_Image,1)-1)]);
        Assume_Axial_Profile=10.^((-1*Exponantial_Coef*Z_Profile)/20);
